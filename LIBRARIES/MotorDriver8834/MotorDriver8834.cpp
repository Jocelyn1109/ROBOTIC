...
const char PROGMEM GO_FORWARD_LOG_MESSAGE[] = "DRV8834 - GO FORWARD";
const char PROGMEM GO_BACKWARD_LOG_MESSAGE[] = "DRV8834 - GO BACKWARD";
const char PROGMEM ENABLE_DRIVER_LOG_MESSAGE[] = "DRV8834 - ENABLE DRIVER";
const char PROGMEM DISABLE_DRIVER_LOG_MESSAGE[] = "DRV8834 - DISABLE DRIVER";
const char PROGMEM SET_FORWARD_DIR_LOG_MESSAGE[] = "DRV8834 - SET FORWARD DIRECTION";
const char PROGMEM SET_BACKWARD_DIR_LOG_MESSAGE[] = "DRV8834 - SET BACKWARD DIRECTION";
