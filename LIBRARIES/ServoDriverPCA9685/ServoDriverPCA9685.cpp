 ...
 */
void ServoDriverPCA9685::setDegrees(const uint8_t numServo, long degrees, long maxDegree, uint16_t servoMin,
                                    uint16_t servoMax, bool is4096) {
 ...
 */
uint16_t ServoDriverPCA9685::convertePulseMicroSecondTo4096(uint16_t pulse) const {
